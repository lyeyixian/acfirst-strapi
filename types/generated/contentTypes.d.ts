...
export interface ApiCartCart extends Schema.CollectionType {
  ...
  attributes: {
    cartId: Attribute.UID & Attribute.CustomField<'plugin::field-uuid.uuid'>;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    enquiry: Attribute.Text;
    name: Attribute.String;
    orderId: Attribute.UID & Attribute.CustomField<'plugin::field-uuid.uuid'>;
    phone: Attribute.String;
    productDetails: Attribute.Component<'elements.order-product-details', true>;
    publishedAt: Attribute.DateTime;
    status: Attribute.Enumeration<['seen', 'contacted', 'closed']>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::order.order',
      'oneToOne',
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    name: Attribute.String;
    productImg: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    publishedAt: Attribute.DateTime;
    similarProducts: Attribute.Relation<
      'api::product.product',
      'oneToMany',
      'api::product.product'
    >;
    ...
    >;
    surface: Attribute.Enumeration<
      ['gloss', 'matte', 'polished', 'baby-skin', 'sugar-face', 'lappato']
    >;
    type: Attribute.Enumeration<['wall', 'floor', 'outdoor']>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::product.product',
      'oneToOne',
